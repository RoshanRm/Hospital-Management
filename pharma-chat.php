            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12">
                    <div class="card planned_task">
                        ...
                        <div class="body">
                            <button class="btn btn-outline-secondary" value="button name" onclick="window.open('https://web.whatsapp.com/')"> <i class="icon-speech"> Currently Working with Whatsapp </i> </button>
